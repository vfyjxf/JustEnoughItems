...
public final class ListGroupElementInfo implements IListElementInfo {
	...
	public ListGroupElementInfo(IngredientGroupInfo groupInfo, List<IListElement> members, IModIdHelper modIdHelper) {
	...
	public ListGroupElement getElement() {
		if (element == null) {
			element = new ListGroupElement(groupInfo, members);
		}
		return element;
	}
